...
const get = async function(req, res) {
  try {
    ...
    let result = await gpio_service.getGpio(parseInt(gpio))
...
const set = async function(req, res) {
  try {
    ...
    let result = await gpio_service.setGpio(parseInt(gpio), type, parseInt(value), webhook, save)
...
const remove = async function(req, res) {
  try {
    ...
    let result = await gpio_service.removeGpio(parseInt(gpio))
